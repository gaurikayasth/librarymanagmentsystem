...
echo "<font color=hotpink>"."<h1 align=center>"."Book On Id table"."</h1>";
echo "</br>";

$insert="insert into bookid(bid,uid,idate,rdate,fine) values('$bid','$uid','$idate','$rdate','$fine')";
...
"</td><td align='center'>"."<font color=navyblue>".$row['fine'].
"</td></br></tr>";
/*echo"<tr>";
