...
echo "<font color=darkblue>"."<h1 align=center>"."issued books on BookBank"."</h1>";
echo "</br>";

$query1="SELECT bb.sr_no,bb.bid,b.bname,b.aname,b.price,b.category,bb.uid,u.name,u.email,u.course,bb.idate,bb.rdate FROM bookbank bb INNER JOIN book b ON bb.bid=b.book_id INNER JOIN user u ON bb.uid=u.user_id";
...
echo "<td>"; ?> <button style="background-color:red; color:white" type="button"><a href="userbookbankdelete.php?sr_no=<?php echo $row["sr_no"];?>" style="background-color:red; color:white">Delete</a></button><?php echo "</td>";
echo "</tr>";
}
echo "</table>";
mysqli_close($con);
